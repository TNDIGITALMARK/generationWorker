...
class ValidationService:
    """Service for handling img2vid workflow validation operations"""
    ...
    async def validate_workflow_by_name(self, workflow_name: str) -> Dict[str, Any]:
        ...
        try:
            logger.info(f"Validating img2vid workflow: {workflow_name}")
    ...
    async def _load_workflow(self, workflow_name: str) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info(f"Loaded img2vid workflow: {workflow_name}")
